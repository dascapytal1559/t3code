...
export const ThreadListV2Row = memo(function ThreadListV2Row(props: {
  ...
  const snoozableCardMenuActions = useMemo<MenuAction[]>(
    ...
    [forkMenuItems, arrangementMenuItems, snoozePresetActions, titleRegenerationMenuItems],
  );
  const cardMenuActions = useMemo<MenuAction[]>(
    ...
    [forkMenuItems, arrangementMenuItems, titleRegenerationMenuItems],
  );
  const slimMenuActions = useMemo<MenuAction[]>(
    ...
    [forkMenuItems, arrangementMenuItems, thread.pinnedAt, titleRegenerationMenuItems],
  );
  const snoozedMenuActions = useMemo<MenuAction[]>(
    ...
    [forkMenuItems, titleRegenerationMenuItems],
  );

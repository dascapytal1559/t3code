...
export const ThreadListV2Row = memo(function ThreadListV2Row(props: {
  ...
  const snoozableCardMenuActions = useMemo<MenuAction[]>(
    ...
    [forkMenuItems, arrangementMenuItems, snoozePresetActions, titleMenuItems],
  );
  const cardMenuActions = useMemo<MenuAction[]>(
    ...
    [forkMenuItems, arrangementMenuItems, titleMenuItems],
  );
  ...
  const snoozedMenuActions = useMemo<MenuAction[]>(
    () => [...forkMenuItems, SNOOZED_MENU_ACTIONS[0]!, ...titleMenuItems, SNOOZED_MENU_ACTIONS[1]!],
    [forkMenuItems, titleMenuItems],
  );

...
const SidebarThreadRow = memo(function SidebarThreadRow(props: {
  ...
  // Git status runs where the project's repository is, which is not the
  // workspace root when the project sets a VCS root.
  const gitCwd = thread.worktreePath ?? (props.project ? projectVcsRoot(props.project) : null);

...
On mobile, Send steers the running turn. Choose **Queue** to hold a follow-up until the whole
turn finishes. You can return a pending message to the composer to edit it.

...
several sources, select the project in Settings → Project and set **Repository directory** for its checkout.
...
project root. This setting applies only to that checkout. Reset the row to use the project root again.

...
On an existing running thread, `mod+enter` queues the composer until the turn
finishes. See [Follow-ups while the agent is working](./composer.md#follow-ups-while-the-agent-is-working).
